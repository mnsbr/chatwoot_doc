...
The APIs (Application Programming Interface) in Katalis.app enable you to connect more external systems than the UI offers.
See the types of APIs in Katalis.app.
...
text will be right where you left it. Katalis.app shall save the data and preserve your unsent messages as drafts. This is
...
Katalis.app has a suite of natively integrated apps that work seamlessly with Katalis.app and enhance your overall experience.
...
attachment, etc., which you can define from your Katalis.app Settings. You can also make a personal macro or one available
for your team's use. You can run a macro from a chat sidebar.

Markdown

Katalis.app uses markdown language in its messages and Help Center articles.
...
iOS or Android. It has a collection of libraries and utilities that can help you integrate Katalis.app with an app.
...
Simple Mail Transfer Protocol (SMTP) is a setting that enables you to send messages from Katalis.app through your email
