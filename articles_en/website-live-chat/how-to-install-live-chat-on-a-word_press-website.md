...
Log in to your WordPress account. Navigate to the Admin Panel and click “Plugins” from the sidebar. You will be able to
see the "Add New" button.

You will see an option to upload the plugin, as shown in the screenshot below. Click “Upload” and select the Zip file
...
3.  Widget Position
    ...
    You can select where to place the live-chat widget on the website based on your preference. The available options
    are Left & Right.
...
5.  Launcher text
    ...
    This is an optional field. If you use the expanded bubble design, you can use the launcher text to customize the
...
Visit your website and see if the widget appears on the website!Last updated on Apr 10, 2024