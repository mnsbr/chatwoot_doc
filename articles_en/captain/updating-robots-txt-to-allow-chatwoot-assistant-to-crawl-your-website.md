...
# Updating robots.txt to Allow Katalis Assistant to Crawl Your WebsiteKatalis uses Firecrawl internally to fetch and index your website content. This allows the Katalis Assistant to answer
...
When that happens:
  ...
  - No documents from your website will be added to Katalis
