# Cara Menginstal Live Chat Menggunakan Google Tag Manager# Cara Menginstal Live Chat Menggunakan Google Tag Manager
...
Login ke workspace Tag Manager dengan akun Google Anda. Anda akan melihat workspace serupa seperti yang ditunjukkan di bawah. Klik tombol "Add a new tag" dari dashboard.
...
Klik "Triggering" dan pilih "All pages" dari daftar.

Klik "Save" untuk menyimpan tag. Anda akan bisa melihat tag terdaftar di Workspace changes. Klik "Submit" untuk mendeploy tag. Berikan nama versi dan deploy perubahan dengan mengklik "Publish".
