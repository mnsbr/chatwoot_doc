...
Login ke akun Webflow Anda dan pilih website Anda. Pilih Settings.

Buka Custom Code → Footer Code. Tempel skrip di "Footer Code". Simpan perubahan.

**Langkah 3.** Publikasikan perubahan

Klik Publish → Pilih website → Publish to selected domains.

**Langkah 4.** Verifikasi

Kunjungi website Anda dan lihat apakah widget muncul di website.
