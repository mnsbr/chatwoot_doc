...
Kelola percakapan akun bisnis WhatsApp Anda melalui Katalis. Anda memiliki dua pilihan provider:
...
Ada dua cara menggunakan Twilio dengan Katalis:
...
Masuk ke akun Katalis Anda, klik Settings > Inbox > Add Inbox dan pilih Whatsapp.
...
Selesai! Anda siap untuk mulai mengirim pesan WhatsApp melalui Katalis.
...
Masuk ke akun Katalis Anda. Saat membuat inbox, centang kotak "Use Twilio Message Service". Kemudian salin dan tempel Account ID, Message Service ID, dan Token ke kolom yang sesuai.

Buka dashboard Twilio Anda, navigasi ke Messaging > Services > Select Service > Integration, dan tempel Webhook URL Anda di sini.

Selesai — Anda sudah siap! Sekarang Anda bisa mulai mengirim pesan WhatsApp melalui Katalis.

## FAQ

### Jenis template WhatsApp apa yang didukung Katalis saat menggunakan Twilio?

Saat ini, Katalis tidak mendukung template dengan Twilio.
