...
**Langkah 7.** Kirim pesan ke bot Telegram. Periksa inbox Telegram Katalis untuk pesan baru.

## FAQ

### Apakah Katalis mendukung akun Telegram Business Bot?

Ya — dukungan untuk bot mode Telegram Business ditambahkan di Katalis v4.3.0 (18 Jun 2025).

### Cara mengaktifkan Business Bot?

1. Di @BotFather jalankan `/business_mode`, pilih bot Anda, dan konfirmasi.
2. Buat inbox Telegram baru di Katalis (Settings → Inboxes → Add Inbox → Telegram) dan tempel token bot yang sama.
3. Katalis otomatis mendeteksi Business Mode dan mendaftarkan webhook yang benar.
...
- **Jendela balasan 24 jam** – Telegram hanya mengizinkan bot (dan Katalis) untuk membalas dalam 24 jam dari pesan terakhir pelanggan.
