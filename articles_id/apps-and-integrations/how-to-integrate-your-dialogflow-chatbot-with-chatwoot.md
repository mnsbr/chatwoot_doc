# Cara Mengintegrasikan Chatbot Dialogflow dengan Katalis
...
Dialogflow dan Rasa.ai adalah platform NLP (Natural Language Processing) terkemuka untuk membangun chatbot kustom. Dalam panduan ini, kami menjelaskan cara membuat bot di Dialogflow dan mengintegrasikannya dengan Katalis dalam hitungan detik.
...
Ini menyelesaikan konfigurasi bot dasar. Mari buat service account dan hubungkan dengan Katalis.

Anda juga bisa membuat intent tambahan untuk kasus penggunaan spesifik Anda. Katalis juga mendukung intent lanjutan yang memungkinkan handoff agen, pesan interaktif, dll. Lihat: Gulir ke bawah ke "Advanced Intents".

**Langkah 3.** Buat service account. Untuk menghubungkan bot ini dengan Katalis, Anda perlu membuat service account di Google Cloud console. Navigasi ke konsol proyek di Google Cloud dengan mengklik Project ID di pengaturan proyek.
...
Lanjutkan dan klik "Done". Langkah berikutnya adalah membuat key agar bisa dibagikan dengan Katalis. Klik service account dan klik tab "Keys". Kemudian, klik "Add Key".
...
## Menyiapkan Integrasi Dialogflow di Katalis

Katalis memiliki integrasi Dialogflow native. Anda bisa menghubungkan bot dengan Katalis dalam dua langkah cepat.
...
Setelah pengguna meminta untuk berbicara dengan agen, Dialogflow harus memberitahu Katalis bahwa agen bisa mengambil alih percakapan.
...
Saat memicu intent dengan payload di atas, Katalis akan mengubah status percakapan menjadi open dan menyerahkannya ke agen.

### Pesan Interaktif

**Catatan:** Pesan interaktif saat ini hanya didukung di inbox website.

Integrasi Katalis-Dialogflow juga mendukung pesan interaktif. Jenis pesan interaktif berikut didukung:
