...
**Langkah 1.** Buka Settings → Integrations → Linear. Klik tombol "Configure".
...
### Membuat isu dari percakapan

Untuk membuat isu baru, buka percakapan apa pun dan klik tombol Linear di header percakapan. Kemudian isi detail isu, termasuk judul, deskripsi, dan tim.

Setelah mengisi detail, klik tombol Create untuk menambahkan isu ke workspace Linear Anda dengan percakapan yang ditautkan.

### Menautkan isu yang sudah ada

Untuk menautkan percakapan dengan tiket yang sudah ada, klik tab link issue, cari tiket, dan klik "Link" untuk menghubungkannya.
