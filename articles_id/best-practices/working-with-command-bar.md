...
Beberapa tindakan/opsi navigasi utama tercantum di bawah.

## Melompat ke Halaman dengan Command Bar

Command bar memungkinkan Anda navigasi cepat ke halaman, seperti Settings, Reports, Notifications, dan lainnya. Mulai ketik nama halaman dan tekan Enter, dan Anda akan dibawa ke halaman tersebut.

### Navigasi Cepat yang Tersedia
...
- Resolve/Reopen percakapan
- Mute/Unmute percakapan
- Kirim transkrip email
- Tetapkan percakapan ke agen
- Tetapkan percakapan ke tim
- Tambahkan label ke percakapan
- Snooze percakapan

### Contoh: Menetapkan Agen

1. Buka command bar
2. Cari "Assign agent" dan tekan Enter
3. Pilih agen yang ingin Anda tetapkan ke percakapan.
