...
Integrasi Twitter telah dihentikan sementara sebagai akibat dari modifikasi yang dilakukan Twitter pada API-nya. Ini termasuk batasan jumlah permintaan per menit, ditambah perubahan harga yang substansial.

Silakan lihat di sini untuk bantuan menyiapkan semua inbox lainnya, selain ketiga inbox yang disebutkan di atas.

### Help Center

Help Center adalah alat yang powerful untuk membuat knowledge base self-service untuk pelanggan dan agen Anda. Anda bisa menerbitkan artikel, mengorganisirnya ke dalam kategori, dan memberikan pengalaman self-service yang mulus.
...
Dengan fitur Campaigns, Anda bisa secara proaktif menjangkau pelanggan dengan pesan satu kali atau berbasis trigger.
